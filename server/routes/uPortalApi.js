...
const uFanPortal = require('../models/uFanPortal')


router.post('/api/portal/:id', function (req, res, next) {
    ...
    if (teamName.length === 0) {
      ...
      uFanPortal.updateFanPortal(req.body, function(success,response){
        if(!success){
...
router.get("/api/portal/:Id", function(req,res,next){
